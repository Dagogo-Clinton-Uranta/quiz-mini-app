...
questionsArray:[{ 
correctAnswer: "A",
optionA: {optionLeter: 'A', optionDesc: 'abuja'},
optionB: {optionLeter: 'B', optionDesc: 'lagos'},
...
const [subjectList,setSubjectList] = useState(presentSubject && presentSubject.body && firstSplit && secondSplit && thirdSplit ?thirdSplit:[])
  ...
  return (
   ...
   <br/><br/>
    ...
    <center>
    <p style={{position:"relative",display:"block",fontWeight:"bold",fontSize:"22px",borderBottom:"4px solid #553A76",width:"max-content"}}>
...
<p style={{position:"relative",marginLeft:"0.4rem",display: 'flex', justifyContent: 'space-between',fontWeight:"bold",fontSize:"18px",paddingBottom:"0.5rem",borderBottom:"3px solid #553A76"}}>
  Q{index +1}.{' '}{chapter.question}
...
<TextField style={{position:"relative",width:"85%",paddingBottom:"0.5rem",alignItems:"center"}}
            fullWidth
